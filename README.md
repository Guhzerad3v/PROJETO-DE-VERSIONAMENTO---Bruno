...
- [ ] **Step 2:** Regras de Negócio, Tipagem e Limites de Slots
- [ ] **Step 3:** Interface visual no console e formatação
- [ ] **Step 4:** Tratamento de erros, modularização e Integração final

###  ISSUE 2 - Sistema de Luta e Magia
Responsável pela matemática do combate, vida, mana e turnos.
- [ ] **Step 1:** Classes base de Entidades (Personagem e Inimigos) com atributos.
